...
double sigmoid(double value) //σ(x) = 1/(1+e⁻ˣ)
{
...
double sigmoidDeriv(double value) //σ'(x) = σ(x) × (1 − σ(x))
{
...
double logarithm(double value)
{
    ...
    double e = exponential(1.0);  // e ≈ 2.71828
    double sqrtE = exponential(0.5); // √e ≈ 1.6487
    int k = 0;
